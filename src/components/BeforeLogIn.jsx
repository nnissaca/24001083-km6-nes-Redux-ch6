        ...
        <div className="flex">
          <ul className="flex justify-center items-center align-center text-white">
            ...
            <div
              ...
              className="focus:border-double p-2 px-5 focus:border-2 border-2 border-white rounded-full hover:bg-gray-500 focus:bg-gray-600 text-white mx-5 bg-gray-400"
            >
              Login
            </div>
            <div
              ...
              className="focus:border-double p-2 px-4 focus:border-2 border-2 border-white rounded-full hover:bg-green-700 focus:bg-green-800 text-white bg-green-600"
            >
              Register
            </div>
          </ul>
